...
class AlloyParams:
    ...
    def get_alloy_params(self, system='ternary'):
...
## ==============================================================================
class Mobility2DEG(AlloyParams):
    def __init__(self, compositions=None, binaries=['AlN', 'GaN'], alloy='AlGaN', 
        ...
        AlloyParams.__init__(self, compositions=compositions, binaries=binaries, alloy=alloy)
        self.get_alloy_params(system=system)
    ...
    def calculate_mobility(self, n_2d=0.1, rms_roughness=0.1, corr_len=1, n_dis=1, f_dis=0.1, 
        ...
        for ii in range(len(self.comps_)):
            ...
            if alloy_disordered_effect:
                mobility[f'{self.comps_[ii]:.3f}']['muADO'] = self._mobility_calculator(alloy_disordered_effect=True, 
                                                                                        mobility_model=mobility_model)
            ...
            if polar_optical_phonon_effect:
                mobility[f'{self.comps_[ii]:.3f}']['muPOP'] = self._mobility_calculator(polar_optical_phonon_effect=True, 
                                                                                        mobility_model=mobility_model)
            if total_mobility:
                mobility[f'{self.comps_[ii]:.3f}']['muTOT'] = self._mobility_calculator(interface_roughness_effect=interface_roughness_effect,
